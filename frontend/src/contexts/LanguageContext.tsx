...
export const translations: Translations = {
  ...
  addItemPlaceholder: { en: "Add another item...", es: "Agregar otro item..." },
  addNewItem: { en: "Add new item", es: "Agregar nuevo item" },
  addItem: { en: "Add item", es: "Agregar item" },
